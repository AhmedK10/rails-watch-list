...
<p align="center">A mini project using Ruby on Rails that allows you to add classic movies into your own separate lists, lets you modify existing lists and allows you remove existing lists.</p>
...
<ul>
	<li>Adding the ability to display the reviews of other users</li>
	<li>The ability to add your own movies</li>
</ul>
